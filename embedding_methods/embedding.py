...
class MinorEmbeddingComposite(dimod.ComposedSampler):
    ...
    def sample(self, bqm, chain_strength=1.0, embed_method='minorminer', **parameters):
        ...
        Args:
            ...
            embed_method (['minorminer','topological','dense'], optional, default='minorminer'):
                Choice of embedding method from provided implementations.
        ...
        # get the embedding
        embedding = embedder.find_embedding(source_edgelist, target_edgelist)
